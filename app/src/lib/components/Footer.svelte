<footer>
	...
	<div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
		<nav class="-mx-5 -my-2 flex-wrap justify-center hidden" aria-label="Footer">
			<div class="px-5 py-2">
		...
		<div class="mt-6 flex justify-center space-x-6 text-sm text-gray-400">
			...
			<a class="hover:text-gray-900" href="/legal/privacy-policy" target="_blank" rel="noopener noreferrer">
				Privacy Policy
			</a>
		</div>
	</div>
