...
>
	...
	<div class="flex w-96 items-center justify-end space-x-4">
		{#if $page.data.session}
			<button
				class="text-base sm:text-lg hover:underline active:underline"
		...
		>
			<svg fill="currentColor" viewBox="0 0 24 24" class="h-10 w-10 text-slate-900 hover:text-slate-700 active:text-slate-800">
				<path
					fill-rule="evenodd"
